            ...
            <div class="rounded-2xl  bg-white flex flex-col shadow-lg p-3 m-2 relative -top-16 h-[280px]">
                ...
                <div class="flex flex-col mt-auto text-xs py-1 ">
                    ...
                    <div class="flex  justify-between items-end">
                        ...
                        <div class="mt-1">
                            <button type="button" data-modal-target="{{ $idModals }}"
                                data-modal-toggle="{{ $idModals }}" class="text-xs text-gray-500">Detail</button>

                            <div id="{{ $idModals }}" data-modal-backdrop="static" tabindex="-1"
                                aria-hidden="true"
