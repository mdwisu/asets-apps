...
<section class="bg-white px-6 lg:px-14">
    ...
    <div id="platform" class="mb-16 mt-16">
        ...
        <div style="margin-bottom: 8rem">
            <h1 class="text-3xl font-semibold" style="margin-bottom: 1rem">Premium Asets Site-Intelligence</h1>
        ...
        <div style="margin-bottom: 8rem">
            <h1 class="text-3xl font-semibold" style="margin-bottom: 1rem">Asets
        ...
        <div id="partnership" style="margin-bottom: 8rem">
            <h1 class="text-3xl font-semibold" style="margin-bottom: 1rem">Strategic Asets Partnership</h1>
            <div class="flex justify-center" style="margin: 1rem 0">
                <div
