    ...
    <section class="bg-white px-6 lg:px-14">
                        ...
                        <template x-for="listing in listingData" :key="listing.listing_id">
                            <div class="rounded-lg flex-col flex ">
                                <div class="relative px-4 flex justify-between top-9 left-1 z-10">
                                    <span 
                                    :class="listing.available == 1 ? 'bg-custom-primary' : 'bg-zinc-700'"
                                            ...
                                            <div class="flex flex-col w-full h-full space-y-1">
                                                ...
                                                <div class="flex">
                                                    <p><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                            viewBox="0 0 24 24" class="size-5 text-custom-primary" fill="currentColor">
                                                            <path fill-rule="evenodd"
                                                ...
                                                <div class="flex ">
                                                    ...
                                                    <p class="leading-relaxed font-semibold ml-2 text-gray-600"
                                                        x-text="`${listing.total_space_available} Total Space Available`"></p>
                                                </div>
                                                <br>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="flex-col flex">
                    <div class="rounded-2xl overflow-hidden">
                        <div class="transform transition-transform duration-300 ease-in-out">
                            <img class="rounded-2xl w-full h-72 object-cover"
                                 src="{{url('assets/img/esg/esg_1.png')}}"
                                 alt="space image">
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white flex flex-col shadow-lg p-3 m-2 -top-14 relative">
                        <div class="flex flex-col text-sm py-1 space-y-3">
                                ...
                                <div style="height: 10rem;" class="px-2 text-sm overflow-y-auto">
                                    <p>Ditch single-use plastics! 🌍💚 Switch to reusable bags, bamboo straws, and more. Every eco-friendly choice counts! 🌱✨ What’s your favorite swap? Share below! ⬇️💬</p>
                                </div>

                                <a href="https://wa.me/62811102239?text=Halo saya ingin bertanya tentang Asets ESG Market: Social Box"
                                target="_blank" class="mt-2 w-full text-center text-white focus:ring-4 font-medium rounded-lg text-lg px-3 py-2" style="background-color: #057A55">Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-col flex">
                    <div class="rounded-2xl overflow-hidden">
                        <div class="transform transition-transform duration-300 ease-in-out">
                            <img class="rounded-2xl w-full h-72 object-cover"
                                 src="{{url('assets/img/esg/esg_2.png')}}"
                                 alt="space image">
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white flex flex-col shadow-lg p-3 m-2 -top-14 relative">
                        <div class="flex flex-col text-sm py-1 space-y-3">
                                ...
                                <div style="height: 10rem;" class="px-2 text-sm overflow-y-auto">
                                    <p>RVM is a automatic system that allows users to return empty plastic bottles in exchange for plastic points. The collected plastic bottle waste will be recycled into useful upcycled products.</p>
                                </div>
                ...
                <div class="flex-col flex">
                    <div class="rounded-2xl overflow-hidden">
                        <div class="transform transition-transform duration-300 ease-in-out">
                            <img class="rounded-2xl w-full h-72 object-cover"
                                 src="{{url('assets/img/esg/esg_3.png')}}"
                                 alt="space image">
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white flex flex-col shadow-lg p-3 m-2 -top-14 relative">
                        <div class="flex flex-col text-sm py-1 space-y-3">
                                <h5 class="font-bold text-md lg:text-xl" style="color: #057A55">Go Green with Aset ESG ! 🌍💚</h5>

                                <div style="height: 10rem;" class="px-2 text-sm overflow-y-auto">
                                    <p>Smart, sustainable, and eco-friendly investments for a greener future! ♻️✨ #GoGreen #AsetESG</p>
                                </div>
                    ...
                    <template x-for="item in spaceData" :key="item.id">
                        <div class="flex-col flex">
                            ...
                            <div class="rounded-2xl overflow-hidden">
                                <div class="transform transition-transform duration-300 ease-in-out">
                                    <img class="rounded-2xl w-full h-72 object-cover"
                                         :src="item.photos?.length ? item.photos[0] : 'https://th.bing.com/th/id/OIP.H1gHhKVbteqm1U5SrwpPgwAAAA?rs=1&pid=ImgDetMain'"
                                         alt="space image">
                                </div>
                            </div>
                            ...
                            <div class="rounded-2xl bg-white flex flex-col shadow-lg p-3 m-2 -top-14 relative h-56">
                                <div class="flex flex-col text-sm py-1 space-y-3">
                                    <div>
                                        <a :href="'https://wa.me/62811102239?text=' + encodeURIComponent('Halo, saya ingin bertanya mengenai lokasi: ' + (item.listing?.listing_name || 'Asets Curated Space'))">
                                            <h5 class="font-bold lg:text-sm text-custom-primary line-clamp-2"
                                    ...
                                    <div class="flex flex-col w-full h-full space-y-1">
                                        ...
                                        <div class="flex ">
                                            ...
                                            <p x-text="item.size_sqm + ' / m²'" class="leading-relaxed font-semibold ml-2 text-gray-600 text-custom-primary">
                                            </p>
                                        </div>
                                    </div>

                                    <a :href="'https://wa.me/62811102239?text=' + encodeURIComponent('Halo, saya ingin bertanya mengenai lokasi: ' + (item.listing?.listing_name || 'Asets Curated Space'))" class="mt-2 w-full text-center text-white bg-purple-950 hover:bg-purple-800 focus:ring-4 font-medium rounded-lg text-md px-3 py-2">Contact</a>
                                </div>
                            </div>
                        </div>
                    </template>
        ...
        <div class="">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-6 mb-24 auto-rows-fr ">
                ...
                <x-card-article :image-article="'https://media.licdn.com/dms/image/v2/D5622AQFhQjJvX1gn_w/feedshare-shrink_2048_1536/feedshare-shrink_2048_1536/0/1731300041883?e=2147483647&v=beta&t=UHlY5hqVLAf4QXzva4CyfRBvvTPsua1vgfOG12WRMM0'" :title-article="'Strategic Partnership between Asets and Bank Syariah Indonesia: Innovative Support for Indonesian Entrepreneurs'" :date-article="'2024-12-07'" :description-article="'We are thrilled to announce a strategic partnership between Asets and Bank Syariah Indonesia (BSI), creating new opportunities for entrepreneurs eager to scale their businesses. '" :link-article="'https://www.linkedin.com/posts/pt-global-indo-asets_strategic-partnership-between-asets-and-bank-activity-7261598699208753152-eDmy?utm_source=share&utm_medium=member_desktop'" />

                <x-card-article :image-article="'https://media.licdn.com/dms/image/v2/D5612AQEPku1Rvvre2w/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1731319096716?e=2147483647&v=beta&t=HCIuYpratIomhrJPjbFTnkOcYA718lPDNTIOQ2E8QvY'" :title-article="'Empowering Local Potential: ASETS x Local Business!'" :date-article="'2024-12-07'" :description-article="'Di ASETS, kami percaya pada potensi besar yang dimiliki oleh bisnis lokal. Dengan dukungan yang tepat, bisnis lokal bisa berkembang pesat dan berkontribusi pada perekonomian serta komunitas yang lebih kuat.'" :link-article="'https://www.linkedin.com/posts/pt-global-indo-asets_empowering-local-potential-asets-x-local-activity-7261678730639548417-oSwh?utm_source=li_share&utm_content=feedcontent&utm_medium=g_dt_web&utm_campaign=copy'" />

                <x-card-article :image-article="'https://media.licdn.com/dms/image/v2/D5622AQEnwMuCZYGdkQ/feedshare-shrink_2048_1536/feedshare-shrink_2048_1536/0/1731300757090?e=2147483647&v=beta&t=rdGSyYiTCenCqYmCo-dHBmvAwXkD7OaixllqqwOpwQQ'" :title-article="'Protect Your Business from Cyber Threats with AI-Powered Ransomware Protection from Asets'" :date-article="'2024-12-07'" :description-article="'In todays digital landscape, cyber threats are constantly evolving, with ransomware attacks posing significant risks to businesses of all sizes. At Asets, we understand the importance of keeping critical data secure, which is why we are excited to introduce our AI-powered ransomware protection solutions. Our advanced tools are designed to help businesses stay one step ahead of cybercriminals, ensuring data protection through state-of-the-art technology and expert collaboration.'"
                    :link-article="'https://www.linkedin.com/posts/pt-global-indo-asets_protect-your-business-from-cyber-threats-activity-7261601695577591808-yn0k?utm_source=li_share&utm_content=feedcontent&utm_medium=g_dt_web&utm_campaign=copy'" />
